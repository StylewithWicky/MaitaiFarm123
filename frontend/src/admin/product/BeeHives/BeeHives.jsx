  ...
  const fetchBeeHives = async (page = 1) => {
    ...
    try {
      const res = await fetch(
        `${BACKEND_URL}/api/get_product_previews?category=Hives&page=${page}`,
        { credentials: "include" }
      );
            ...
            products.map(product => (
              <div key={product.product_id} className={styles.card}>
                ...
                <div className={styles.cardBody}>
                  <Link
                    to={`/admin/products/Hives/${product.product_id}`}
        ...
        {pagination.pages > 1 && (
          <div className={styles.pagination}>
            <button
              ...
              onClick={() => fetchBeeHives(pagination.prev)}
            >
              Prev
            </button>
            ...
            <button
              ...
              onClick={() => fetchBeeHives(pagination.next)}
            >
              Next
            </button>
          </div>
